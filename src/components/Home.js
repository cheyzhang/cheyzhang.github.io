...
const Home = () => {
  return (
    <div className="home-container flex flex-col mx-auto mb-6">
      <div className="rounded-full drop-shadow-2xl">
        <img
          src={require('../assets/me_princeton.jpeg')}
          alt="work please"
          width="200"
          height="200"
      ...
      <div className="home-text">
        ...
        <ul className="about-list">
          <li>
            ...
            <ul className="nested-list list-inside">
              <li>
        ...
        <p>
          ...
          , or shoot me an{' '}
          <a
            href="mailto:cheyz1318@gmail.com"
            className="bolded-text"
            target="_blank"
            rel="noopener noreferrer"
          >
